...
- [PASS] Audit log events recorded — count=20
- [PASS] Sandbox invocations recorded — count=15
- [PASS] Task completions recorded — count=25
- [PASS] Task errors logged to event store — count=5
