...
export default function AppearancePage() {
  ...
  // Appearance Store
  const {
    theme, accentColor, followSystemTheme, sidebarTranslucent, 
    reduceAnimations, compactMode, highContrast,
    loadSettings, updateSetting, importTheme, exportTheme, resetToDefaults,
    isLoaded
  } = useAppearanceStore();
    ...
    <SettingsNavigation 
      ...
      footerAction={
        <button 
          ...
          className="w-full flex items-center justify-center gap-2 py-2.5 px-4 bg-white border border-gray-200 rounded-xl text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors"
        >
          <RefreshCw size={14} />
          Restore Defaults
        </button>
    ...
    <div className="space-y-6">
          ...
          <div className="flex h-40">
            ...
            <div className="flex-1 bg-white p-3 flex flex-col">
              ...
              <div className="flex gap-2 mb-3 self-end">
                <div className="w-20 h-10 rounded-lg bg-indigo-50 text-indigo-600 flex items-center justify-center rounded-tr-none border border-indigo-100">
                  <Code size={14} />
                </div>
                <div className="w-5 h-5 rounded-full bg-indigo-500 shrink-0"></div>
              </div>
      ...
      <SettingsCard title="Quick Actions">
        <div className="space-y-2">
          <button 
            onClick={resetToDefaults}
            className="w-full py-2.5 px-4 bg-white border border-gray-200 rounded-xl text-sm font-semibold text-gray-700 hover:bg-gray-50 flex items-center gap-3 transition-colors text-left"
          >
      ...
      <SettingsCard title="Current Theme Details">
        <div className="space-y-3">
          <DetailRow label="Mode" value={theme.charAt(0).toUpperCase() + theme.slice(1)} />
          <div className="flex items-center justify-between text-sm">
            <span className="text-gray-600 font-medium">Accent Color</span>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full" style={{ backgroundColor: accentColor }}></div>
              <span className="font-bold text-gray-900">{accentColor.toUpperCase()}</span>
            </div>
          </div>
  ...
  return (
    ...
    >
      <div className="animate-in fade-in slide-in-from-bottom-2 h-full flex flex-col w-full">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-500 mt-0.5">Customize how NEXUS-R looks and feels.</p>
            </div>
          </div>
        </div>

        {/* Detail Tabs */}
        <div className="flex gap-6 border-b border-gray-100 mb-8 overflow-x-auto pb-1 scrollbar-hide">
          <button className="pb-2 text-sm font-bold text-indigo-600 border-b-2 border-indigo-600 whitespace-nowrap">Theme</button>
          <button className="pb-2 text-sm font-bold text-gray-500 hover:text-gray-700 whitespace-nowrap">Layout</button>
          <button className="pb-2 text-sm font-bold text-gray-500 hover:text-gray-700 whitespace-nowrap">Chat Interface</button>
          <button className="pb-2 text-sm font-bold text-gray-500 hover:text-gray-700 whitespace-nowrap">Typography</button>
          <button className="pb-2 text-sm font-bold text-gray-500 hover:text-gray-700 whitespace-nowrap">Colors</button>
          <button className="pb-2 text-sm font-bold text-gray-500 hover:text-gray-700 whitespace-nowrap">Icons & Logos</button>
        </div>

        {/* Theme Mode Section */}
        <div className="mb-8">
          <h4 className="text-[15px] font-bold text-gray-900 mb-1">Theme Mode</h4>
          <p className="text-sm font-medium text-gray-500 mb-4">Choose your preferred theme for the application.</p>
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <ThemeCard 
              ...
              preview={
                <div className="w-full h-16 bg-white border border-dashed border-gray-300 rounded-lg p-2 flex flex-col gap-1.5">
                  <div className="flex gap-1 items-center">
                  ...
                  <div className="flex-1 rounded border border-indigo-100 bg-gradient-to-r from-indigo-50 to-rose-50"></div>
                </div>
              }
            />
          </div>
        ...
        <div className="mb-8">
          <h4 className="text-[15px] font-bold text-gray-900 mb-1">Accent Color</h4>
          <p className="text-sm font-medium text-gray-500 mb-4">Choose the primary color used across NEXUS-R.</p>
          ...
          <div className="flex gap-3 items-center">
            ...
            <button className="w-8 h-8 rounded-full flex items-center justify-center border border-gray-200 bg-white ml-2 hover:bg-gray-50 transition-colors shadow-sm">
        ...
        <div>
          <h4 className="text-[15px] font-bold text-gray-900 mb-1">Theme Settings</h4>
          ...
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden mt-4">
            <ToggleRow 
              ...
              onChange={(c) => updateSetting('followSystemTheme', c)} 
            ...
            <ToggleRow 
              ...
              onChange={(c) => updateSetting('sidebarTranslucent', c)} 
            ...
            <ToggleRow 
              ...
              icon={<MousePointer2 size={16} className="text-gray-500" />}
              className="border-b border-gray-100 last:border-0"
            />
  ...
  return (
    <div 
      ...
      className={clsx(
        ...
        active ? "bg-indigo-50/30 border-indigo-500 shadow-sm ring-1 ring-indigo-500" : "bg-white border-gray-200 hover:border-gray-300 hover:bg-gray-50 shadow-sm"
      )}
    >
      ...
      <p className="text-xs font-medium text-gray-500 leading-relaxed mb-4 flex-1">{description}</p>
